"""
Main experimentation pipeline for measuring precision on tabular datasets
...
def run_test(config: dict) -> List[float]:
    """
    Run precision experiment with a given configuration
    Args:
...
if __name__ == '__main__':
    ...
    # Run main
    main(config_dir=config_dir, save_dir=save_dir, metric='precision', configs=configs,
