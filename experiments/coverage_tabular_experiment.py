"""
Main experimentation pipeline for measuring coverage on tabular datasets
...
from experiments.experiments_common import main, measure_coverage, Binarizer
...
if __name__ == '__main__':
    ...
    # Run main
    main(config_dir=config_dir, save_dir=save_dir, metric='coverage', configs=configs,
